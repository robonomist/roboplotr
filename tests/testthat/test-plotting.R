...
test_that("Roboplot options are reset", {
  ...
  expect_mapequal(getOption("roboplot.grid"), list(xcolor = "#E8E8E8", ycolor = "#E8E8E8", xcolor_minor = NULL, ycolor_minor = NULL, xwidth = 1, ywidth = 1, xdash = "solid", ydash = "solid",xtick = NULL, ytick = NULL))
  ...
  expect_setequal(getOption("roboplot.modebar"), list(buttons = c("closest","compare","img_w","data_dl"), display = "hover", zoom = 1))
  expect_setequal(getOption("roboplot.patterntypes"), c("","/","\\","x","-","|","+","." ))
  expect_mapequal(getOption("roboplot.imgdl.wide"), list(x = 1280, y = 720, title = 18, main = 15, caption = 11, suffix = "", type = "png", button_label = "Lataa kuvio (leveä)"))
  expect_mapequal(getOption("roboplot.imgdl.narrow"), list(x = 810, y = 720, title = 18, main = 15, caption = 11, suffix = "", type = "png", button_label = "Lataa kuvio (kapea)"))
  expect_mapequal(getOption("roboplot.imgdl.small"), list(x = 889, y = 500, title = 16, main = 13, caption = 10, suffix = "", type = "png", button_label = "Lataa kuvio (pieni)"))
