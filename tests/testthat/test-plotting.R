...
test_that("Roboplot options are reset", {
  ...
  expect_mapequal(getOption("roboplot.font.caption"), list(size = 10, font = "Arial", fallback = NULL, path = NULL, color = "#696969"))
  expect_mapequal(getOption("roboplot.font.main"), list(size = 14, font = "Arial", fallback = NULL, path = NULL, color = "#696969"))
  expect_mapequal(getOption("roboplot.font.title"), list(size = 17, font = "Arial", fallback = NULL, path = NULL, color = "#696969", bold = TRUE))
