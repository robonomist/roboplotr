...
test_that("Test for hovertemplate templating list", {
  expect_named(roboplot_set_hovertext(NULL), c("dateformat","rounding","unit","extra"))
  expect_equal(roboplot_set_hovertext(rounding = 3)$rounding, 3)
  expect_match(roboplot_set_hovertext(frequency = "Daily")$dateformat, "%d.%m.%Y")
})
...
test_that("Roboplot options are reset", {
  ...
  expect_mapequal(getOption("roboplot.font.caption"), list(size = 10, family = "sans-serif", path = NULL, color = "#696969"))
  expect_mapequal(getOption("roboplot.font.main"), list(size = 14, family = "sans-serif", path = NULL, color = "#696969"))
  expect_mapequal(getOption("roboplot.font.title"), list(size = 17, family = "sans-serif", path = NULL, color = "#696969", bold = TRUE))
